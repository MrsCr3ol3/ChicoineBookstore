...
public class CategoryDaoJdbc implements CategoryDao {
    ...
    private static final String FIND_LAST_CATEGORY =
            "SELECT category_id, name " +
                    "FROM category " +
    ...
    public long getMaxCategoryID() {
        Category category = null;
        try (Connection connection = JdbcUtils.getConnection();
             PreparedStatement statement = connection.prepareStatement(FIND_LAST_CATEGORY)) {
            ...
            throw new BookstoreQueryDbException("Encountered a problem finding last category name", e);
        }
